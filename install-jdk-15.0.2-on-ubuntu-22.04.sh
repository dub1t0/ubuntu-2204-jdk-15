...
# Define variables
JDK_X64_URL="https://github.com/dub1t0/ubuntu-2204-jdk-15/raw/main/jdk-15.0.2_linux-x64_bin.tar.gz"
#JDK_X32_URL="https://github.com/dub1t0/ubuntu-2204-jdk-15/raw/main/jdk-15.0.2_linux-x64_bin.tar.gz"
JAVA_DIR="jdk-15.0.2"
DOWNLOAD_PATH="/tmp/"
...
ARCH=$(uname -m)
if [ "$ARCH" == "x86_64" ]; then
    JDK_VERSION="jdk-15.0.2_linux-x64_bin.tar.gz"
    JDK_URL="$JDK_X64_URL"
else
    JDK_VERSION="jdk-15.0.2_linux-x64_bin.tar.gz"
    JDK_URL="$JDK_X32_URL"
